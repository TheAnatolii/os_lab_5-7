...
public:
    Message(MessageTypes messageType, int senderId, int receiverId, int _sizeOfBody, void *_body) : messageType(
                                                                                                        messageType),
                                                                                                    senderId(senderId), recieverId(receiverId), sizeOfBody(_sizeOfBody), body(nullptr)
    {
        if (sizeOfBody > 0)
        {
    ...
    Message(MessageTypes messageType, int senderId, int receiverId, const char *str) : Message(messageType, senderId, receiverId)
    {
